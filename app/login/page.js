...
import { Mail, Lock, ArrowRight, Sparkles, LayoutDashboard, ShieldCheck } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-[#030303] font-sans selection:bg-teal-500/30">
      ...
      >
        ...
        {/* LEFT VISUAL PANEL (Mirrors Registration Page) */}
        <div className="relative w-full md:w-[48%] h-72 md:h-auto overflow-hidden group">
          <motion.div 
            ...
            // Uses the bright coffee shop image from the signup page
            style={{ backgroundImage: `url('https://images.unsplash.com/photo-1611974714851-eb6053e6235b?q=80&w=1200&auto=format&fit=crop')` }} 
          />
          ...
          <div className="absolute inset-0 p-14 flex flex-col justify-between z-20">
            ...
            >
              ...
              <span className="font-bold tracking-[0.3em] text-white/50 uppercase text-[10px]">Secure Access</span>
            </motion.div>
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <Sparkles size={14} /> Encrypted Session
              </motion.div>
        ...
        <div className="flex-1 bg-[#0c0c0c] p-10 md:p-20 flex flex-col justify-center">
          <div className="max-w-md mx-auto w-full">
            <motion.header 
              ...
              className="mb-12"
            >
              <h1 className="text-4xl font-black text-white mb-3 tracking-tight">Identity Access</h1>
              <p className="text-gray-500 text-sm font-medium">Verify your credentials to enter the analyzer</p>
            </motion.header>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <AnimatePresence>
                {error && (
                  <motion.div 
                    ...
                    className="bg-red-500/10 border border-red-500/20 text-red-400 px-5 py-4 rounded-2xl text-[11px] font-bold uppercase tracking-wider flex items-center gap-3"
                  >
              ...
              <div className="space-y-4">
                ...
                <div className="relative group">
                  ...
                  <div className="relative bg-[#111] border border-white/5 rounded-2xl py-1 transition-all group-focus-within:border-teal-500/50">
                    ...
                    <input
                      type="email"
                      placeholder="vault@protocol.io"
                      value={email}
                      onChange={(e) => setEmail(e.target.value)}
                      className="w-full bg-transparent py-4 pl-14 pr-6 text-white placeholder:text-gray-700 focus:outline-none transition-all outline-none"
                      required
                    />
                  </div>
                </div>
              ...
              <motion.button
                whileHover={{ scale: 1.02, boxShadow: "0 0 30px rgba(255,255,255,0.05)" }}
                whileTap={{ scale: 0.98 }}
                disabled={loading}
                className="w-full bg-white text-black font-black py-5 rounded-2xl flex items-center justify-center gap-3 group relative overflow-hidden transition-all"
              >
            ...
            <div className="my-10 flex items-center gap-5 text-gray-800">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[9px] font-black uppercase tracking-[4px]">Biometric Secure</span>
              </div>
              <div className="h-[1px] flex-1 bg-white/5" />
            </div>
            ...
            <footer className="mt-12 text-center">
              ...
              <Link href="/signup" className="mt-3 block text-teal-400 font-black hover:text-teal-300 transition-colors text-xs">
